        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (state == State.LINE) {
                ...
                if (pixelsSelected == 2) {
                    ...
                    // Use CategoryPlot set various parameters. The following settings can be
                    // omitted.
    ...
    private JMenuBar createMenu() {
        ...
        miHisto.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                boolean urls = false;
                var chart = ChartFactory.createHistogram(plotTitles, xaxis, yaxis, dataset, PlotOrientation.VERTICAL,
                        show, toolTips, urls);
        ...
        miCumHisto.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                var chart = new ChartPanel(getActiveImage().get().cumHistogram, new String[] {},
        ...
        miMapChanges.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String thresholdStr = JOptionPane.showInputDialog(MainFrame.this, "Input threshold: ",
        ...
        miMuestrate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String samples = JOptionPane.showInputDialog(MainFrame.this, "Input sample size",
                        JOptionPane.QUESTION_MESSAGE);
                try {
        ...
        miDigitalize.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    int bits = Integer.parseInt(JOptionPane.showInputDialog(MainFrame.this, "Input bit number",
                            JOptionPane.QUESTION_MESSAGE));
